...
import trabalhopraticoesii.parser.entity.ParsedData;
    ...
    /**
     * Manipulates parsed data and converts it into a structured representation of a
     * product system ({@link ProductSystem}).
     *
     * @param parsedData The parsed data obtained from various sources, including CSV files.
     ...
     */
public interface DataManipulator extends CsvDataManipulator{
	@Override
